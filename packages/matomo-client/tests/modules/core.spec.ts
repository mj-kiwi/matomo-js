...
describe("CoreReportingClient", () => {
  ...
  describe("request method", () => {
    it("should make a POST request by default (securityMode enabled)", async () => {
    ...
    it("should make a GET request when securityMode is disabled", async () => {
      // Create client with securityMode disabled
      ...
      // Make the request
      await client.request("API.getMatomoVersion");
    ...
    it("should handle axios errors", async () => {
      ...
      (mockAxiosInstance.post as any).mockRejectedValueOnce(axiosError);
    ...
    it("should rethrow non-axios errors", async () => {
      ...
      (mockAxiosInstance.post as any).mockRejectedValueOnce(genericError);
  ...
  describe("bulkRequest method", () => {
    ...
    it("should use GET for bulk requests when securityMode is disabled", async () => {
      // Create client with securityMode disabled
      client = new CoreReportingClient({
        ...defaultOptions,
        securityMode: false,
      ...
      const methods = {
        "API.getMatomoVersion": {},
        "API.getSiteData": { idSite: 2 },
      };

      await client.bulkRequest(methods);
