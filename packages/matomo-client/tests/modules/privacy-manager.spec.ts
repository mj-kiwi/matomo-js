...
import { PrivacyManagerModule } from '../../src/modules/privacy-manager.js';
...
describe('PrivacyManagerModule', () => {
  ...
  describe('findDataSubjects', () => {
    it('should call the API with required parameters', async () => {
      ...
      const result = await privacyManagerModule.findDataSubjects(1, 'userId==abc');
  ...
  describe('anonymizeSomeRawData', () => {
    it('should call the API with required parameters', async () => {
      ...
      const result = await privacyManagerModule.anonymizeSomeRawData([1, 2], '2023-01-01');
  ...
  describe('getAvailableVisitColumnsToAnonymize', () => {
    it('should call the API correctly', async () => {
      ...
      const result = await privacyManagerModule.getAvailableVisitColumnsToAnonymize();
  ...
  describe('getAvailableLinkVisitActionColumnsToAnonymize', () => {
    it('should call the API correctly', async () => {
      ...
      const result = await privacyManagerModule.getAvailableLinkVisitActionColumnsToAnonymize();
