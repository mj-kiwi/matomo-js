...
import { SitesManagerModule } from '../src/modules/sites-manager.js';
...
describe('SitesManagerModule', () => {
  ...
  describe('getJavascriptTag', () => {
    it('should call the API with required parameters', async () => {
      const mockResponse = { code: '<!-- Matomo --><script>/* JS code */</script>' };
      mockClient.request.mockResolvedValueOnce(mockResponse);
  ...
  describe('getImageTrackingCode', () => {
    it('should call the API with required parameters', async () => {
      const mockResponse = { code: '<img src="https://example.org/matomo/matomo.php?idsite=1" />' };
      mockClient.request.mockResolvedValueOnce(mockResponse);
    ...
    it('should call the API with all parameters', async () => {
      const mockResponse = { code: '<img src="https://example.org/matomo/matomo.php?idsite=1&action_name=Purchase&idgoal=1&revenue=19.99" />' };
      mockClient.request.mockResolvedValueOnce(mockResponse);
  ...
  describe('getSitesFromGroup', () => {
    it('should call the API without parameters', async () => {
      const mockResponse = [{ id: 1, name: 'Site 1' }, { id: 2, name: 'Site 2' }];
      mockClient.request.mockResolvedValueOnce(mockResponse);
  ...
  describe('getSiteFromId', () => {
    it('should call the API with idSite parameter', async () => {
      const mockResponse = { id: 1, name: 'Example Site', url: 'https://example.org' };
      mockClient.request.mockResolvedValueOnce(mockResponse);
  ...
  describe('getSitesWithAtLeastViewAccess', () => {
    ...
    it('should call the API with limit parameter', async () => {
      ...
      const result = await sitesManagerModule.getSitesWithAtLeastViewAccess(5);
  ...
  describe('getSitesIdWithAtLeastViewAccess', () => {
    it('should call the API without parameters', async () => {
      ...
      const result = await sitesManagerModule.getSitesIdWithAtLeastViewAccess();
  ...
  describe('getSitesIdFromSiteUrl', () => {
    it('should call the API with url parameter', async () => {
      ...
      const result = await sitesManagerModule.getSitesIdFromSiteUrl('https://example.org');
  ...
  describe('addSiteAliasUrls', () => {
    it('should call the API with required parameters', async () => {
      ...
      const result = await sitesManagerModule.addSiteAliasUrls(1, 'https://alias.example.org');
  ...
  describe('getIpsForRange', () => {
    it('should call the API with ipRange parameter', async () => {
      ...
      const result = await sitesManagerModule.getIpsForRange('192.168.1.1-2');
  ...
  describe('setGlobalExcludedIps', () => {
    it('should call the API with excludedIps parameter', async () => {
      ...
      const result = await sitesManagerModule.setGlobalExcludedIps('192.168.1.1,10.0.0.1');
  ...
  describe('getSearchKeywordParametersGlobal', () => {
    it('should call the API without parameters', async () => {
      ...
      const result = await sitesManagerModule.getSearchKeywordParametersGlobal();
  ...
  describe('getSearchCategoryParametersGlobal', () => {
    it('should call the API without parameters', async () => {
      ...
      const result = await sitesManagerModule.getSearchCategoryParametersGlobal();
  ...
  describe('getExcludedQueryParametersGlobal', () => {
    it('should call the API without parameters', async () => {
      const mockResponse = ['utm_source', 'utm_medium', 'utm_campaign', 'gclid'];
      mockClient.request.mockResolvedValueOnce(mockResponse);

      const result = await sitesManagerModule.getExcludedQueryParametersGlobal();
  ...
  describe('setGlobalExcludedUserAgents', () => {
    it('should call the API with excludedUserAgents parameter', async () => {
      ...
      const result = await sitesManagerModule.setGlobalExcludedUserAgents('bot,spider,crawl');
  ...
  describe('setGlobalExcludedReferrers', () => {
    it('should call the API with excludedReferrers parameter', async () => {
      ...
      const result = await sitesManagerModule.setGlobalExcludedReferrers('spam.com,unwanted.org');
  ...
  describe('setKeepURLFragmentsGlobal', () => {
    it('should call the API with enabled parameter', async () => {
      ...
      const result = await sitesManagerModule.setKeepURLFragmentsGlobal(true);
  ...
  describe('setDefaultTimezone', () => {
    it('should call the API with defaultTimezone parameter', async () => {
      ...
      const result = await sitesManagerModule.setDefaultTimezone('Europe/Paris');
  ...
  describe('setGlobalQueryParamExclusion', () => {
    it('should call the API with required parameters', async () => {
      ...
      const result = await sitesManagerModule.setGlobalQueryParamExclusion('exact');
    ...
    it('should call the API with all parameters', async () => {
      ...
      const result = await sitesManagerModule.setGlobalQueryParamExclusion('exact', 'utm_*');
  ...
  describe('getExclusionTypeForQueryParams', () => {
    it('should call the API without parameters', async () => {
      ...
      const result = await sitesManagerModule.getExclusionTypeForQueryParams();
  ...
  describe('getCurrencyList', () => {
    it('should call the API without parameters', async () => {
      const mockResponse = { 'USD': 'US Dollar', 'EUR': 'Euro', 'GBP': 'British Pound' };
      mockClient.request.mockResolvedValueOnce(mockResponse);
  ...
  describe('getTimezoneName', () => {
    it('should call the API with required parameters', async () => {
      ...
      const result = await sitesManagerModule.getTimezoneName('Europe/Paris');
  ...
  describe('renameGroup', () => {
    it('should call the API with required parameters', async () => {
      ...
      const result = await sitesManagerModule.renameGroup('Old Group', 'New Group');
  ...
  describe('getPatternMatchSites', () => {
    ...
    it('should call the API with all parameters', async () => {
      ...
      const result = await sitesManagerModule.getPatternMatchSites('example', 10, [2, 3]);
  ...
  describe('getNumWebsitesToDisplayPerPage', () => {
    it('should call the API without parameters', async () => {
      ...
      const result = await sitesManagerModule.getNumWebsitesToDisplayPerPage();
