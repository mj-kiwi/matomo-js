...
import { TransitionsModule } from '../../src/modules/transitions.js';
...
describe('TransitionsModule', () => {
  ...
  describe('getTransitionsForPageTitle', () => {
    it('should call the API with required parameters', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('Transitions.getTransitionsForPageTitle', {
        pageTitle: 'Home Page',
        idSite: 1,
        period: 'day',
        date: 'today',
  ...
  describe('getTransitionsForPageUrl', () => {
    it('should call the API with required parameters', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('Transitions.getTransitionsForPageUrl', {
  ...
  describe('getTransitionsForAction', () => {
    it('should call the API with required parameters', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('Transitions.getTransitionsForAction', {
        actionName: 'Home',
        actionType: 'page',
        idSite: 1,
        period: 'day',
  ...
  describe('getTranslations', () => {
    it('should call the API', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('Transitions.getTranslations', {});
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe('isPeriodAllowed', () => {
    it('should call the API with required parameters', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('Transitions.isPeriodAllowed', {
        idSite: 1,
        period: 'day',
        date: 'today',
      });
